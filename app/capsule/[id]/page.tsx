...
function PropertyCard({
  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur transition-all hover:border-[var(--orbit-glow)]/20">
      {/* Property Content */}
      <div className="p-5">
        {/* Header with type and time */}
        <div className="mb-3 flex items-center justify-between">
          <span className="rounded-lg bg-[var(--orbit-glow)]/10 px-2.5 py-1 text-[10px] font-medium text-[var(--orbit-glow)]">
            {getPropertyTypeLabel(property.type)}
          </span>
          <span className="flex items-center gap-1 text-[10px] text-[var(--orbit-text-muted)]/80">
        ...
        <div className="flex gap-4">
          {/* Icon */}
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-white/5 backdrop-blur text-[var(--orbit-glow)]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-0.5 flex items-center gap-1 text-sm text-[var(--orbit-text-muted)]/80">
            ...
            <div className="mt-2 flex items-center gap-3">
              ...
              <span className="text-sm text-[var(--orbit-text-muted)]/70">
                {property.area}
              </span>
              {property.bedrooms && (
                <span className="text-sm text-[var(--orbit-text-muted)]/70">
          ...
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 rounded-xl py-2.5 text-sm font-medium transition-all ${
              isFavorited
                ...
                : "bg-white/5 text-[var(--orbit-text-muted)] hover:bg-white/10 hover:text-rose-400"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 rounded-xl py-2.5 text-sm font-medium transition-all ${
              isVisited
                ...
                : "bg-white/5 text-[var(--orbit-text-muted)] hover:bg-white/10 hover:text-emerald-400"
            }`}
          >
